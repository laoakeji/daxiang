...
<style>
.dabiaotiss { font-family: "微软雅黑"; font-size: 53px; color: #fff; font-weight: bold; padding-top: 5%; text-align: center; width: 100%;margin-top: 30px; }
</style>

<!--内容-->
<div class="neiye_banner" style="background:url(/Public/Home/images/team_head.jpg) no-repeat center center;background-size: cover; width:100%; height:400px; position:relative;">
<div class="clear"></div>
...
<!-- <div class="guanjiancicci">以人为本，服务社会，共建和谐，合作共赢</div> -->
	<div class="neiye_navq">
		<?php if(($id) == "1"): ?><a href="<?php echo U('Index/team');?>?id=1" class="neiye_hover">入驻团队<span></span></a>
		<?php else: ?>
			<a href="<?php echo U('Index/team');?>?id=1">入驻团队<span></span></a><?php endif; ?>
		
		<?php if(($id) == "2"): ?><a href="<?php echo U('Index/team');?>?id=2" class="neiye_hover">孵化项目<span></span></a>
		<?php else: ?>
			<a href="<?php echo U('Index/team');?>?id=2">孵化项目<span></span></a><?php endif; ?>
		<div class="clear"></div>      
    </div>
</div>
...
<div class="neiye_cen">
<div class="clear"></div>
<div class="shouye_guanyu_biaoti"> <em>
<?php if($id == 1 ): ?>入驻团队
<?php else: ?> 
入驻项目<?php endif; ?>
</em><br>
...
<div class="shouye_guanyu_xiangxi lin">
	...
	<div class="shouye_qiehuan_xinwe shouye_qiehuan_xinwe_neiye">
	  <div class="bd">
	    <ul class="picList">
			<?php if($id == 1 ): ?><table style="border-width: 0px; padding: 0px; margin: 0px; border-spacing: 0px; border-collapse: collapse;">
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="height:120px;">
						<th align="left" valign="top" style="margin-top:20px;margin-left:5px;">
							<div>
								<a hidefocus="true" href="" target="_self"  mix="1" style="font-size: 18px;color: #5e5e5e;font-weight: bold;"><?php echo ($i); ?>、<?php echo ($vo["desc"]); ?></a>
							</div>
							<div>
								<p style="font-size: 12px;color: #797979;padding: 4px 0 0 0;overflow: hidden;text-overflow: ellipsis;"><?php echo ($vo["content"]); ?></p>
							</div>	
						</th>
					 </tr><?php endforeach; endif; else: echo "" ;endif; ?>
			</table>
			<?php else: ?>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list">
				<div class="pic"><a href="<?php echo U('Home/Index/detail_team');?>?id=<?php echo ($vo["id"]); ?>"><img src="<?php echo ($vo["image"]); ?>"></a></div>
				<div class="title">
					<div class="xinwen_biaoti_shouye"><a href="" title=""><?php echo ($vo["desc"]); ?></a></div>
				</div>
