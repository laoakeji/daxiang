...
<!--内容-->
<div class="neiye_banner" style="background:url(/Public/Home/images/service_head.png) no-repeat center center;background-size: cover; width:100%; height:450px; position:relative;">
<div class="clear"></div>

<div class="dabiaotiss" style="color:#f6881b !important;">服务支持</div>
<!-- <div class="guanjiancicci">以人为本，服务社会，共建和谐，合作共赢</div> -->
	<div class="neiye_navq">
		<?php if(($id) == "4"): ?><a href="<?php echo U('Index/service');?>?id=4" class="neiye_hover">产业基金<span></span></a>
		<?php else: ?>
			<a href="<?php echo U('Index/service');?>?id=4">产业基金<span></span></a><?php endif; ?>
		
		<?php if(($id) == "5"): ?><a href="<?php echo U('Index/service');?>?id=5" class="neiye_hover">基础服务<span></span></a>
		<?php else: ?>
			<a href="<?php echo U('Index/service');?>?id=5">基础服务<span></span></a><?php endif; ?>
		<div class="clear"></div>      
    </div>
</div>
<div class="neiye_cen">
