...
<!--内容-->
<div class="neiye_banner" style="background:url(/Public/Home/images/com_head.png) no-repeat center center;background-size: cover; width:100%; height:450px; position:relative;">
<div class="clear"></div>
...
<div class="neiye_cen">
<div class="clear"></div>
<div class="shouye_guanyu_biaoti"> <em>发起单位</em><br>
  <!-- <span>ABOUT US</span> -->
</div>
<div class="shouye_guanyu_xiangxi lin">
    <style>span{background-color: transparent!important;}</style>
    <h4 style="text-align:center;font-size: 33px"><em><?php echo ($list["title"]); ?></em></h4>
