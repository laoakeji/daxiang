...
<!--内容-->
<div class="neiye_banner" style="background:url(/Public/Home/images/about_us_head.png) no-repeat center center;background-size: cover; width:100%; height:450px; position:relative;">
<div class="clear"></div>
<div class="dabiaotiss" style="color:#f6881b !important;"></div>
<!-- <div class="guanjiancicci">以人为本，服务社会，共建和谐，合作共赢</div> -->
	<div class="neiye_navq">
		<?php if(($id) == "1"): ?><a href="<?php echo U('Index/wlist');?>?id=1" class="neiye_hover">公司简介<span></span></a>
		<?php else: ?>
			<a href="<?php echo U('Index/wlist');?>?id=1">公司简介<span></span></a><?php endif; ?>
		
		<?php if(($id) == "2"): ?><a href="<?php echo U('Index/wlist');?>?id=2" class="neiye_hover">管理团队<span></span></a>
		<?php else: ?>
			<a href="<?php echo U('Index/wlist');?>?id=2">管理团队<span></span></a><?php endif; ?>
		
		<?php if(($id) == "3"): ?><a href="<?php echo U('Index/wlist');?>?id=3" class="neiye_hover">组织架构<span></span></a>
		<?php else: ?>
			<a href="<?php echo U('Index/wlist');?>?id=3">组织架构<span></span></a><?php endif; ?>
		
		<?php if(($id) == "4"): ?><a href="<?php echo U('Index/wlist');?>?id=4" class="neiye_hover">孵化范围<span></span></a>
		<?php else: ?>
			<a href="<?php echo U('Index/wlist');?>?id=4">孵化范围<span></span></a><?php endif; ?>
		<div class="clear"></div>      
    </div>
</div>
<div class="neiye_cen">
<div class="clear"></div>
<div class="shouye_guanyu_biaoti"> <em><?php echo ($list["title"]); ?></em><br>
  <!-- <span>ABOUT US</span> -->
</div>
