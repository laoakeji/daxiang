  ...
  <form id="form2" method="post" class="form form-horizontal" id="form-article-add">
   ...
   <input type="hidden" name="type" value="6"></input>
    ...
    <div class="row cl">
      ...
      <textarea name="content" id="myeditor" style="width:90%px;height:300px"><?php echo ($list["content"]); ?></textarea>
      </div> 
    </div>
  ...
  <script type="text/javascript">
      $(function(){
        $('#sub_form2').click(function(){
          ...
          $.post("<?php echo U('Index/do_edit');?>?table=news&id="+id,data,function(data){
            if (data>=1) {
              //layer.msg("修改成功");
              alert("修改成功");
