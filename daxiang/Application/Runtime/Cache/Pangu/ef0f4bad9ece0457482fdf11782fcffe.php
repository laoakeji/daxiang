...
<div class="pd-20">
  <form id="form2" method="post" class="form form-horizontal" id="form-article-add">
	...
	<?php if(($ids) == "1"): ?><input type="hidden" name="type" value="4"></input>
	<?php else: ?>
		<input type="hidden" name="type" value="5"></input><?php endif; ?>
    ...
    <div class="row cl">
      ...
      <label>预览：</label>
      <img id="img1" style="hight:64px;width:64px" src="<?php echo (is_img($list["image"])); ?>">
      <input type="hidden" id="image" name="image" value="<?php echo (is_img($list["image"])); ?>">
    </div>
    ...
    <div class="row cl">
      ...
      <textarea name="content" id="myeditor" style="width:90%px;height:320px"><?php echo ($list["content"]); ?></textarea>
      </div> 
    </div>
